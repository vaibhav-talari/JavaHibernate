...
import core.java.exceptions.Exception1;
import core.java.exceptions.Exception2;

import core.java.model.Book;
import core.java.model.Subject;

import core.java.service.LibraryService;
...
public class MainController {
	...
	private static void captureDetailSubject(Subject subject) throws Exception1 {
		...
		try {
		int no = Integer.parseInt(scanner.next());//if i use int no=scanner.nextInt() in try catch block then also an exception is thrown.
